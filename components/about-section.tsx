          ...
          <div className="grid grid-cols-2 gap-4">
            {stats.map((stat, index) => (
              ...
              >
                ...
                {/* Inner card content */}
                <div className="relative h-full w-full bg-primary/10 backdrop-blur-sm border border-primary/50 hover:bg-primary/20 transition-colors duration-300 rounded-[14px] p-6 z-10 flex flex-col justify-center shadow-xl">
